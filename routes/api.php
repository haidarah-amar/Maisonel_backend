...
Route::group(
    ['prefix' => 'order/owner', 'middleware' => 'auth:sanctum'],
    function () {
...
// favorites routes
Route::group(
    ['prefix' => '/favorites', 'middleware' => 'auth:sanctum'],
    function () {
...
Route::group(
    ['prefix' => '/rating', 'middleware' => 'auth:sanctum'],
    function () {
...
Route::group([
    ...
    Route::get('/credit-cards', [UserController::class, 'index']);
    Route::post('/credit-cards', [UserController::class, 'store']);
});
