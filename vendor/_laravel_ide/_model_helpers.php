...
namespace App\Models {
     ...
     */
    class Appartment extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property mixed $appartment_id
     * @property mixed $user_id
     * @property int $id
     * @property-read \App\Models\User $user
     * @property-read \App\Models\Appartment $appartment
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereAppartmentId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereGuestCount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereCheckInDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereCheckOutDate($value)
     ...
     * @property mixed $status
     * @property mixed $requestable_id
     * @property string $requestable_type
     * @property mixed $user_id
     * @property int $id
     * @property-read \App\Models\Requestt $requestable
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt whereRequestableType($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt whereRequestableId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt whereTargetId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Requestt>|Requestt query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Requestt extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
